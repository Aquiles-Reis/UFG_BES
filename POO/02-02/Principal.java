...
public class Principal {
    public static void main(String[] args) {
        ...
        System.out.println("Produto 1 - construtor sem parametros");
        Produto produto1 = new Produto();
        System.out.println("Codigo gerado automaticamente: " + produto1.getCodigo());
        ...
        System.out.println();
        System.out.println("Produto 2 - construtor com nome");
        String nome2 = lerTexto(scanner, "Nome: ");
        Produto produto2 = new Produto(nome2);
        System.out.println("Codigo gerado automaticamente: " + produto2.getCodigo());
        ...
        System.out.println();
        System.out.println("Produto 3 - construtor com nome e quantidade");
        String nome3 = lerTexto(scanner, "Nome: ");
        int quantidade3 = lerInt(scanner, "Quantidade: ");
        Produto produto3 = new Produto(nome3, quantidade3);
        System.out.println("Codigo gerado automaticamente: " + produto3.getCodigo());
        ...
        Produto produto4 = new Produto(nome4, quantidade4, tipo4, valor4);
        System.out.println("Codigo gerado automaticamente: " + produto4.getCodigo());
